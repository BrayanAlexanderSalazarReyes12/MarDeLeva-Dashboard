...
const AnimatedGaugeWidgetagua = ({ CO }) => {
  ...
  const progress = value.to(v => (v / 3000) * 100);

  // Interpolating value to strokeDashoffset
  const strokeDashoffset = value.to(v => 283 - (v / 3000) * 283);
...
export default AnimatedGaugeWidgetagua;